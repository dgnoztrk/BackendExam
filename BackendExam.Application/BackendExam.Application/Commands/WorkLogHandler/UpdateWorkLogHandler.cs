...
{
    public class UpdateWorkLogHandler : IRequestHandler<UpdateWorkLogCommand, Response<WorkLogDto>>
    {
        private readonly IMapper _mapper;
        private readonly IUnitOfWork _unitOfWork;

        public UpdateWorkLogHandler(IMapper mapper, IUnitOfWork unitOfWork)
        {
            _mapper = mapper;
            _unitOfWork = unitOfWork;
        }

        public async Task<Response<WorkLogDto>> Handle(UpdateWorkLogCommand request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                _unitOfWork.WorkLogRepository.Update(entity);
